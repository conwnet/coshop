(function () {
	...
	angular
		.module('app')
		.controller('AgencyResultController', AgencyResultController);

		AgencyResultController.$inject = ['$scope', '$http', '$window', '$timeout', '$location', '$state', '$stateParams', 'API', 'ENUM'];

	function AgencyResultController($scope, $http, $window, $timeout, $location, $state, $stateParams, API, ENUM) {
