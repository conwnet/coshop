...
/* 外网 */
define('MATRIX_HOST','http://www.matrix.ecos.xxx.cn');//外网申请绑定
define('MATRIX_COMMIT_URL_SYNC','http://matrix.ecos.xxx.cn/sync');//矩阵同步API
define('MATRIX_REALTION_URL','http://www.matrix.ecos.xxx.cn/?');//关系绑定API
define('SMS_RESOURCE_URL', 'http://resource.xxx.cn');//短信平台地址
define('YUNQI_LOGISTIC_URL','http://es.xxx.cn/');/* 云起物流地址 */
define('AUTH_USER_URL', 'http://license.xxx.cn');/* 授权地址 */
define('YUNQI_ACCOUNT_URL', 'https://account.xxx.cn/cashier');/* 云起收银地址 */
...
define('OPENAPI_SITE', 'https://openapi.xxx.cn');
define('OPENAPI_OAUTH', 'https://openapi.xxx.cn/oauth');

/* 云起服务地址 */
define('YUNQI_SERVICE_URL','http://fw.yunqi.xxx.cn/iframe?');
...
/* 版本地址 */
define('VERSION_GBK', 'http://cloud.xxxx.com/version/release_gbk.txt');
define('VERSION_UTF8', 'http://cloud.xxxx.com/version/release_utf8.txt');
