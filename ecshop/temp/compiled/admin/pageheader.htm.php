...
<?php endif; ?>
<span class="action-span1"><a href="index.php?act=main">云博畜牧商城</a> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->_var['ur_here']; ?> <?php endif; ?></span>
