...
<body>
<div id="header-div">
  <div id="logo-div" style="bgcolor:#000000;"><span style="font-size: 30px; margin-left: 10px;">云博畜牧商城</span>
  </div>
  ...
  <div id="submenu-div">
    <ul>
      ...
      <li class="personal-set" onmouseover="showBar(this);" onmouseleave="hideBar(this);">
        <a href="privilege.php?act=modif" target="main-frame"><?php echo $this->_var['lang']['profile']; ?></a>
