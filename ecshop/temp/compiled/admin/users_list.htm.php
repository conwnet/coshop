...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('email'); ">推荐人手机号</a><?php echo $this->_var['sort_email']; ?></th>
...
?>
  <tr>
    ...
    <td><span onclick="listTable.edit(this, 'edit_email', <?php echo $this->_var['user']['user_id']; ?>)"><?php echo $this->_var['user']['referee']; ?></span></td>
