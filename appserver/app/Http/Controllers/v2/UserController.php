...
class UserController extends Controller
{
    ...
    public function qiandao()
    {
        ...
        if($member && $member->is_qiandao == true) {
            return $this->json(['error_code' => 0, 'error_msg' => '您今天已经签到过啦']);
        }
        if(AccountLog::logAccountChange(0, 0, 0, 10, '签到获取')) {
            return $this->json(['error_code' => 0, 'error_msg' => '签到成功！']);
        } else {
            return $this->json(['error_code' => 0, 'error_msg' => '签到失败！']);
        }
    }
