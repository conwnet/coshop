...
{
    $app->post('ecapi.recommend.bonus.info', 'HackController@hack'); // I dont know why, just hack the 404
    $app->post('ecapi.recommend.bonus.list', 'HackController@hack'); // I dont know why, just hack the 404
...
{
    $app->post('ecapi.user.qiandao', 'UserController@qiandao');
